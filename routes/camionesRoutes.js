...
// ✅ OBTENER ESTADÍSTICAS DE CAMIONES (ANTES de :id para evitar conflictos)
// GET /api/camiones/estadisticas
router.get('/estadisticas', requireAuth, camionesController.getEstadisticasCamiones);

// ✅ RUTAS GLOBALES DE MANTENIMIENTOS (ANTES de :id para evitar conflictos)
...
// ✅ CREAR GASTO DESDE MANTENIMIENTO
// POST /api/camiones/mantenimientos/:id/crear-gasto
router.post('/mantenimientos/:id/crear-gasto', requireAuth, mantenimientosController.crearGastoDesdeMantenimiento);
...
// ===== RUTAS DE MANTENIMIENTOS POR CAMIÓN =====
